...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario> 
			(new Usuario(0L, "Juan Malachias", "malachias@hotmail.com", "123456789", "-", null ));
	...
	public void naoDeveDuplicarUsuario() {
		usuarioService.cadastrarUsuario(new Usuario(0L, "Juan Malachias", "JuanMalachias123@hotmail.com", "123456789", null, null));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario
				(new Usuario(0L, "Juan Malachias", "JuanMalachias123@hotmail.com", "123456789", null, null));
		
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(),
				"Juan Malachias", "JuanMalachias123@hotmail.com", "123456789", null, null);
	...
	public void deveMostratTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Tati Silva", "Silva3@email.com", "123456789", null, null));
		
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Juan Malachias", "malachias4@email.com", "123456789", null, null));
